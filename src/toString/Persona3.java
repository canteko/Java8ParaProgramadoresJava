...
class Persona3 {
    ...
    public Persona3(String name, String appellidos, int edad, int altura, float peso) {
        this.nombre = name;
    ...
    // Constructor con parametros
    public Persona3(String name, String apellidos, int edad, int altura) {
    	this(name, apellidos, edad, altura, 80.0f);
    }
    
    // Constructor con parametros
    public Persona3(String name, String apellidos, int edad) {
    	this(name, apellidos, edad, 180, 80.0f);
    }
    
    // Constructor con parametros
    public Persona3(String name, String apellidos) {
    	this(name, apellidos, 50, 180, 80.0f);
    }
    
    // Constructor con parametros
    public Persona3(String name) {
